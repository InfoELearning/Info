      ...
      <div class="modal__body">
        ...
        <div class="files">
          <File
            ...
            class="file"
            :name="material.name"
            :extension="material.name.split('.').pop()"
...
export default {
  ...
  data() {
    return {
      ...
      selectedType: this.task.withMark ? 'С оценкой' : 'Без оценки',
      dateEnd: null,
      dateEndHours: null,
      dateEndMinutes: null,
      dateStart: null,
      dateStartHours: null,
      dateStartMinutes: null,
  ...
  created() {
    if (this.task.dateStart) {
      ...
      this.dateStartHours = this.addZero(new Date(this.task.dateStart).getHours());
      this.dateStartMinutes = this.addZero(new Date(this.task.dateStart).getMinutes());
    }

    if (this.task.dateEnd) {
      this.dateEnd = new Date(this.task.dateEnd);
      this.dateEndHours = this.addZero(new Date(this.task.dateEnd).getHours());
      this.dateEndMinutes = this.addZero(new Date(this.task.dateEnd).getMinutes());
    }
  },
  ...
  methods: {
    async submitModal() {
      ...
      if (this.materials) {
        ...
        for (const file of this.materials) {
          if (!file.fileUrl) {
